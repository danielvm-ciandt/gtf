...
import { getGlobalGSDPreferencesPath, getLegacyGlobalGSDPreferencesPath, getProjectGSDPreferencesPath, loadGlobalGSDPreferences, loadProjectGSDPreferences, loadEffectiveGSDPreferences, resolveAllSkillReferences, } from "./preferences.js";
...
async function configureModels(ctx, prefs) {
    ...
    if (availableModels.length > 0) {
        ...
        for (const phase of modelPhases) {
            ...
            if (!providerChoice || typeof providerChoice !== "string" || providerChoice === "(keep current)")
                continue;
 ...
 */
export async function writePreferencesFile(path, prefs, ctx, opts) {
